...
public class LPRunException : Exception
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LPRunException" /> class with a specified error message and a
    ...
    /// <summary>
    /// Rethrows the exception thrown by <paramref name="action" /> as <see cref="LPRunException" />. Keeps the original
    /// exception as <see cref="P:System.Exception.InnerException" />.
    /// </summary>
    ...
    /// <summary>
    /// Rethrows the exception thrown by <paramref name="func" /> as <see cref="LPRunException" />. Keeps the original
    /// exception as <see cref="P:System.Exception.InnerException" />.
    /// </summary>
    ...
    /// <summary>
    /// Rethrows the exception thrown by asynchronous <paramref name="func" /> as <see cref="LPRunException" />. Keeps the
    /// original exception as <see cref="P:System.Exception.InnerException" />.
    /// </summary>
    /// <typeparam name="TResult">The <paramref name="func" /> result type.</typeparam>
