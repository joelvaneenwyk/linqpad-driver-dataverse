...
public static class Options
{
    ...
    {
        /// <summary>
        /// Switch enables compiler optimizations. This incurs the usual trade-off: slightly faster execution with
        /// compute-intensive code in exchange for less accurate error reporting.
        /// </summary>
